      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            spacing: 16,
            children: [
              Text("Pedidos", style: Theme.of(context).textTheme.titleSmall),
              ...
              if (bagProvider.listDishesOnBag.isEmpty)
                SizedBox(
                  height: 100,
                  child: Center(child: Text("Sacola vazia")),
                ),
              Text("Pagamentos", style: Theme.of(context).textTheme.titleSmall),
              CheckoutWidget(
                onTap: () {},
                leading: Image.asset("assets/others/visa.png", width: 30),
              ...
              Text("Confirmar", style: Theme.of(context).textTheme.titleSmall),
              Container(
